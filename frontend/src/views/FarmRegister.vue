...
async function handleCreate() {
  ...
  await router.push({ name: 'FarmDetail', params: { id: newId } })
  alert('농장이 등록되었습니다.')
}
  ...
  <main>
    ...
    <div class="py-4 container-fluid">
      <div class="row">
        <div class="col-md-8">
          <div class="card">
            <FarmHeader mode="register" :canEdit="false" @submit="handleCreate" />
            <div class="card-body">
              <FarmForm
                :readOnly="false"
              ...
              <div class="row"><div class="col-md-12">
                <FarmImageUploader v-model:file="profileFile" :disabled="false" />
              </div></div>
            </div>
          </div>
        </div>
